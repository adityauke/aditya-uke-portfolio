...
function ProjectSection() {
  ...
  <Consumer>
      ...
      <div className="container text-center py-5" >
        ...
        <div className="lead pb-4">I built these projects during the academic year.</div>
        ...
        <div className="my-2">
          <Link style={{ textDecoration: "none", fontWeight:"10px" }} to="/project/all" className=" text-dark">See all projects <i className="bi bi-arrow-right"></i></Link>
        </div>
      </div>
    );
      }}
