  ...
  constructor(props) {
    ...
    projects: [
        ...
        },
      {
          ...
          description: "A real-time weather-app displaying live weather data, while adapting its icons and background to reflect current weather and day-night conditions.",
          imgUrl: require("./assets/weather.png"),
          prjLink: "https://adi-weather-app.netlify.app/",
        },
        {
          id: 4,
